...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "TayyipCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
       ...
       {"seed.TayyipCoin.com", "seed.TayyipCoin.com"},
    // {"TayyipCoinpool.org", "dnsseed.TayyipCoinpool.org"},
...
void ThreadOpenAddedConnections(void* parg)
{
    ...
    // Make this thread recognisable as the connection opening thread
    RenameThread("TayyipCoin-opencon");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. TayyipCoin is probably already running."), addrBind.ToString().c_str());
        else
