...
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // TayyipCoin: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "TayyipCoin Signed Message:\n";
...
int64 static GetBlockValue(int nHeight, int64 nFees, uint256 prevHash)
{
        ...
        if(nHeight < 100000)    
        {
                ...
                seed = hex2long(cseed);
                rand1 = generateMTRandom(seed, 33333);
        ...
        else if(nHeight < 200000)      
        {
                ...
                cseed = cseed_str.c_str();
                seed = hex2long(cseed);
                rand1 = generateMTRandom(seed, 22222);
                nSubsidy = (1 + rand1) * COIN;
        }
        else if(nHeight < 300000)      
        {
                ...
                cseed = cseed_str.c_str();
                seed = hex2long(cseed);
                rand2 = generateMTRandom(seed, 11111);
        ...
        else if(nHeight < 400000)      
        {
                ...
                cseed = cseed_str.c_str();
                seed = hex2long(cseed);
                rand3 = generateMTRandom(seed, 3333);
        ...
        else if(nHeight < 500000)      
        {
                ...
                cseed = cseed_str.c_str();
                seed = hex2long(cseed);
                rand4 = generateMTRandom(seed, 2222);
...
static const int64 nTargetTimespan = 60 * 60; // TayyipCoin: retarget every 1 hours
static const int64 nTargetSpacing = 60; // TayyipCoin: every block in 1 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlock *pblock)
{
    ...
    // TayyipCoin: This fixes an issue where a 51% attack can change difficulty at will.
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal TayyipCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TayyipCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
CBlock* CreateNewBlock(CReserveKey& reservekey)
{
    ...
    int64 nFees = 0;
    {
        ...
        while (!mapPriority.empty())
        {
            ...
            // TayyipCoind: Reduce the exempted free transactions to 500 bytes (from Bitcoin's 3000 bytes)
